							...
							<div class="board_list_wrap">
								<div class="board_list">
									...
									<div>
										<div></div>
										<div class="id">
											이름<br> <input type="text" placeholder=" 이름">
										</div>
										<div class="id">
											닉네임<br> <input type="text"
												placeholder=" 활동하실 닉네임을 알려주세요!">
										</div>
										<div class="id">
											휴대폰 번호<br> <input type="text" maxlength='11'
												id="cellPhone" placeholder=" 01012345678">
										</div>
										<div class="id">
											이메일<br> <input type="text" id="email" placeholder=" 이메일">
										</div>
										<div class="btn">
