			...
			<div style="margin-top: 25px; display: flex; justify-content: center">
				<section style="position: relative">
							...
							<div class="board_list_wrap">
								...
								<div class="board-page-wrapper">
									<div class="board_page">
										...
										%>				
											<a class="num" href="/board/world-information-board?page=<%=i%>"><%=i%></a>
										<%
										}
										%>
					...
					<aside id="sub-menu"
						...
						<h3>해외여행</h3>
						<h4>
							<a href="world-information-board">여행지정보</a>
						</h4>
						<h4>
							<a href="world-gyotong-board">항공/교통</a>
						</h4>
						<h4>
							<a href="world-friends-board">일행구하기</a>
						</h4>
						<h4>
							<a href="world-review-board">여행후기</a>
						</h4>
